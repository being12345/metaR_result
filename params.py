...
def get_params():
    ...
    args.add_argument("-epo", "--epoch", default=50, type=int)
    args.add_argument("-prt_epo", "--print_epoch", default=5, type=int)
    args.add_argument("-eval_epo", "--eval_epoch", default=51, type=int)
